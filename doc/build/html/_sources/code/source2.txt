...
of a polygon and returns the type of polygon ("square", "rectangle", or "invalid") or
provides users with a way to provide a set of four angles and returns whether the polygon is a "square",
"rhombus", or "disconnected"
